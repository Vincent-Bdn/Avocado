...
namespace Avocado.Server.Data.Migrations
{
    ...
    [Migration("20260908083844_TheSauvegardeCarriesTheDocuments")]
    partial class TheSauvegardeCarriesTheDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Avocado.Server.Features.Backups.CapturedFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasIndex("MatterId", "RelativePath")
                        .IsUnique();

                    b.ToTable("captured_files", (string)null);
                });
            ...
            modelBuilder.Entity("Avocado.Server.Features.Backups.CapturedFile", b =>
                {
                    b.HasOne("Avocado.Server.Features.Matters.Matter", null)
                        .WithMany()
                        .HasForeignKey("MatterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
