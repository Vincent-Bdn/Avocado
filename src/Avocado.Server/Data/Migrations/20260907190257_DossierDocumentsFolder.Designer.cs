...
namespace Avocado.Server.Data.Migrations
{
    ...
    [Migration("20260907190257_DossierDocumentsFolder")]
    partial class DossierDocumentsFolder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Avocado.Server.Features.Backups.BackupDestination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.Property<int>("KeepDailyForDays")
                        .HasColumnType("INTEGER")
                        .HasColumnName("keep_daily_for_days");

                    b.Property<int>("KeepNewest")
                        .HasColumnType("INTEGER")
                        .HasColumnName("keep_newest");
                    ...
                    b.Property<string>("LastBackupAt")
                        .HasColumnType("TEXT")
                    ...
                    b.Property<string>("RemoteFolderId")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT")
                        .HasColumnName("remote_folder_id");
                    ...
                    b.ToTable("backup_destinations", (string)null);
                });

            modelBuilder.Entity("Avocado.Server.Features.Billings.BillingCost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.ToTable("billing_costs", (string)null);
                });
            ...
            modelBuilder.Entity("Avocado.Server.Features.Documents.Checkout.MatterCheckout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.Property<bool>("AwaitingDecision")
                        .HasColumnType("INTEGER")
                        .HasColumnName("awaiting_decision");
                    ...
                    b.ToTable("matter_checkouts", (string)null);
                });
            ...
            modelBuilder.Entity("Avocado.Server.Features.Matters.Matter", b =>
                {
                    ...
                    b.Property<string>("DocumentsFolder")
                        .HasColumnType("TEXT")
                        .HasColumnName("documents_folder");
